...
class Setting(DateStamp):
    ...
    trade_union_name = models.CharField(verbose_name='Название профсоюза', db_comment='Название профсоюза', max_length=200, default='ППО')
    trade_union_description = RichTextField(verbose_name='Описание профсоюза', db_comment='Описание профсоюза', config_name='all_text', default='Описание профсоюза')
